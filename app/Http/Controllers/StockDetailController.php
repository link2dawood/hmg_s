...
{
    private $type     =  "stock Details";
    private $singular =  "Stock Detail";
    private $plural   =  "Stock Details";
    private $view     =  "stockDetails.";
    private $action   =  "/dashboard/stockDetails";
    private $db_key   =  "id";
    private $perpage = 5;
    ...
    public function list(Request $request,$id=NULL)
    {
        ...
        GET RECORDS
        */
        $records   = StockDetail::where("stock_id","=",$id);
    ...
    public function create(Request $request,$id=NULL)
    {
        if($request->isMethod('POST')){
            ...
            for($i=0; $i<count($data['barcode']); $i++){
                $Areas = new StockDetail;
                $Areas->barcode = $data['barcode'][$i];
                $Areas->stock_id = $data['stock_id'];
