...
{
    private $type     =  "suppliers";
    private $singular =  "Supplier";
    private $plural   =  "Suppliers";
    private $view     =  "suppliers.";
    private $action   =  "/dashboard/suppliers";
    private $db_key   =  "id";
    private $perpage = 5;
    ...
    public function list(Request $request)
    {
        ...
        GET RECORDS
        */
        $records   = Supplier::where("office_id","=",Auth::user()->office);
    ...
    public function ledger(Request $request,$id)
    {
        ...
        /*
        GET RECORDS Purchase::find($id)->getStock
        */
        $records   = Ledger::where('supplier_id','=',$id);
        $records   = $this->search($records,$request,$data)->orderBy('id','DESC');
        /*
        GET TOTAL RECORD BEFORE BEFORE PAGINATE
        */
