...
{
    private $type     =  "storageAreas";
    private $singular =  "Storage Area";
    private $plural   =  "Storage Areas";
    private $view     =  "storageAreas.";
    private $action   =  "/dashboard/storageAreas";
    private $db_key   =  "id";
    private $perpage = 5;
    ...
    public function list(Request $request)
    {
        ...
        GET RECORDS
        */
        $records   = StorageArea::where('office_id','=',Auth::user()->office);
    ...
    public function create(Request $request)
    {
        if($request->isMethod('POST')){
            ...
            $is_save             = StorageArea::where('name','=',
                                                $data['name'])
                                                ->count();
            if($is_save > 0)    {
    ...
    public function update(Request $request,$id = NULL)
    {
        ...
        $data   = array(
                    ...
                    "row" => StorageArea::find($id)
                );
        return view($this->view.'edit',$data);
    }
    public function delete($id) {
        StorageArea::destroy($id);
