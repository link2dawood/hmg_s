...
class ItemTypeController extends Controller
{
    ...
    private $singular =  "Item Type";
    private $plural   =  "Item Types";
    private $view     =  "items/itemTypes.";
    private $action   =  "/dashboard/items/itemTypes";
    private $db_key   =  "id";
    private $perpage = 5;
