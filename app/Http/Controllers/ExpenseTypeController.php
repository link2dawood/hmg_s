...
class ExpenseTypeController extends Controller
{
    ...
    private $singular =  "Expense Type";
    private $plural   =  "Expense Types";
    private $view     =  "/expenses/expenseType.";
    private $action   =  "/dashboard/expenses/expenseType";
    private $db_key   =  "id";
    private $perpage = 5;
    ...
    public function list(Request $request)
    {
        ...
        GET RECORDS
        */
        $records   = ExpenseType::where("office_id","=",Auth::user()->office)->where("company_id","=",Auth::user()->company);
    ...
    public function create(Request $request)
    {
        if($request->isMethod("POST")){
            ...
            $is_save             = ExpenseType::where('name','=',
                                                $data['name'])
                                                ->count();
            if($is_save > 0)    {
