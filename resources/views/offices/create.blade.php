            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <input type='text' name="office_name" id="label" class="form-control" required="" value=""  />
                    </div>
                </div>
                ...
                <div class="col-md-12">
                    ...
                    <label for="label" class="control-label">Phone No.</label>
                        <input type='text' name="office_phone" id="label" class="form-control" required="" value=""  />
                    </div>
                </div>
                ...
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <textarea  name="office_address" id="description" class="form-control"></textarea>
                    </div>
                </div>  
            </div>
        </div>
