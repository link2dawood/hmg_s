        ...
        <tbody>
          ...
          <tr>
            <td scope="row">{{$sindex++}}</th>
              <td data-id="{{$val['id']}}" data-input="text" data-field="label">{{$val['office_name']}}</td>
              <td data-id="{{$val['id']}}" data-input="textarea" data-field="description">{{$val['office_phone']}}</td>
              <td data-id="{{$val['id']}}" data-input="textarea" data-field="description">{{App\Models\Office::find($val['id'])->getCompany->name}}</td>
              <td data-id="{{$val['id']}}" data-input="textarea" data-field="description">{{$val['office_address']}}</td>
              <td>
                <div class="dropdown">
