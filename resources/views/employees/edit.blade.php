        ...
        <div class="modal-body">
            <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <select class="form-control" name="company">
                                ...
                                <option value="{{$company->id}}" {{$row->company == $company->id ? 'selected':''}}>{{$company->name}}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
                ...
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <select class="form-control" name="office">
                            ...
                            <option value="{{$office->id}}" {{$row->office == $office->id ? 'selected':''}}>{{$office->office_name}}</option>
                            @endforeach
                        </select>
                    </div>
                </div>
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type='password' name="password" id="label" class="form-control"/>
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="form-group">
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type='file' name="profile_image" id="label" class="form-control"/>
                </div>
            </div>
                <div class="col-md-6">
                    <div class="form-group">
