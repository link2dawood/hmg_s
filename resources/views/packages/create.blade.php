            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <textarea type='description' name="description" id="label" class="form-control" required="" ></textarea>
                    </div>
                </div> 
                <div class="col-md-12">
                    <div class="form-group">
                        <label for="label" class="control-label">Price</label>
                        <input type='price' name="price" id="label" class="form-control" required="" >
                    </div>
                </div> 
            </div>
        </div>
