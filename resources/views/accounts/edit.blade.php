            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <input type='text' name="holder_name" id="label" class="form-control" required="" value="{{$row->holder_name}}"  />
                    </div>
                </div>
                ...
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <input type='text' name="account_title" id="label" class="form-control" required="" value="{{$row->account_title}}"  />
                    </div>
                </div>
                ...
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <select class="form-control" name="bank_id">
                            ...
                            <option value="{{$bank->id}}" {{$row->bank_id == $bank->id ? 'selected':''}}>{{$bank->name}}</option>
                            @endforeach
                        </select>
                    </div>
                </div>
                ...
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <input type='text' name="account_number" id="label" class="form-control" required="" value="{{$row->account_number}}"  />
                    </div>
                </div>
            </div>
        </div>
